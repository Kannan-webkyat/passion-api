...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .mid-wrap { width: 100%; margin-top: 6px; }
        .mid-wrap td { vertical-align: top; }
        .words {
            font-size: 8px;
            font-weight: 600;
            margin-bottom: 4px;
        ...
        .summary-box td { padding: 2px 0; font-size: 7.5px; }
        .summary-box .sum-l { text-align: left; }
        .summary-box .sum-r { text-align: right; font-weight: 600; }
        .summary-box tr.bold td { font-weight: 700; border-top: 1px solid #999; padding-top: 4px; }
        .footer {
            margin-top: 10px;
            width: 100%;
            border-collapse: collapse;
    ...
    <table class="footer">
        <tr>
            ...
            <td style="width:50%; border:1px solid #000; padding:6px;">
                ...
                @if($bankDetails !== '')
                    <div style="white-space:pre-wrap;">{!! nl2br(e($bankDetails)) !!}</div>
                @else
                    <div style="color:#666;">Bank details — configure in Settings (invoice_bank_details)</div>
                @endif
            </td>
        </tr>
    </table>
