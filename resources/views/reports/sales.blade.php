...
<head>
    ...
    <style>
        ...
        .summary-box { border: 1px solid #eee; padding: 10px; text-align: center; }
        .summary-box .label { font-size: 10px; text-transform: uppercase; color: #888; font-weight: bold; }
        .summary-box .value { font-size: 16px; font-weight: bold; margin-top: 5px; }
        table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        th { background: #f9f9f9; text-align: left; padding: 8px; border-bottom: 2px solid #eee; font-size: 10px; text-transform: uppercase; }
        ...
        .status-void { text-decoration: line-through; color: #94a3b8; }
    </style>
</head>
<body>
    <div class="header">
