...
class LandedCostAllocatorTest extends TestCase
{
    ...
    public function test_landed_unit_includes_base_cess_and_freight_with_final_rounding_only(): void
    {
        $po = new PurchaseOrder([
            'subtotal' => 5000,
        ...
        $landed = LandedCostAllocator::forGrnLine($po, $poItem, 10, $grnMerch);
        ...
        $this->assertEqualsWithDelta(540.0, $landed['landed_unit_purchase'], 0.01);
    }
}
