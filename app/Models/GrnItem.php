...
class GrnItem extends Model
{
    protected $fillable = [
        ...
        'landed_unit_cost',
        'line_recoverable_tax_accepted',
        'line_non_recoverable_tax_accepted',
        'tax_input_credit_eligible',
        'rejection_reason',
        'rejection_notes',
        'quality_status',
        'expiry_date',
    ...
    protected $casts = [
        ...
        'line_recoverable_tax_accepted' => 'decimal:2',
        'line_non_recoverable_tax_accepted' => 'decimal:2',
        'tax_input_credit_eligible' => 'boolean',
        'expiry_date' => 'date',
