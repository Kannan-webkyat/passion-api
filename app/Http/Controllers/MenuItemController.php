...
class MenuItemController extends Controller
{
    ...
    {
        return response()->json(MenuItem::with(['category', 'subCategory', 'restaurantMaster'])->get());
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'is_active' => 'boolean',
            'image' => 'nullable|image|max:2048|jpg,jpeg,png,gif,svg,webp'
        ]);
    ...
    {
        return response()->json($menuItem->load(['category', 'subCategory', 'restaurantMaster']));
    }
