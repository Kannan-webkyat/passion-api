...
class RoomTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'early_check_in_type' => 'nullable|string|in:per_hour,flat_fee,percentage',
            'late_check_out_fee' => 'nullable|numeric|min:0',
            'late_check_out_type' => 'nullable|string|in:per_hour,flat_fee,percentage',
            ...
            'rate_plans.*.meal_plan_type' => 'required_with:rate_plans|string|in:room_only,breakfast,half_board,full_board',
